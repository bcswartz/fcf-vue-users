        ...
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              <pre id="configExample" style="margin-left:3em;padding:5px;border:1px solid gray">
var config = {
  apiKey: "YOUR_API_KEY",
...
export default config;
            ...
            <li>
                A modal window will appear to let you choose the security rules for your database.  Since this is
                a demo application, select "Start in test mode", and click the "Enable" button.
            </li>
            <li>
